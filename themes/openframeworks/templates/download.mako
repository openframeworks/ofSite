...
<div id="body-wrap">
    ...
    <div id="download-latest-header">
	    ...
	    % if breaking:
	        <h3>${helpers.msg("breaking", locals())} ${helpers.msg("please_see", locals())}</h3>
	    % else:
	        <h3>${helpers.msg("non_breaking", locals())} ${helpers.msg("please_see", locals())}</h3>
	    % endif
	    <p>${helpers.msg("intro", locals())}</p>
    </div>

    <div id="download-bg-desktop">
        <div id="download-latest-platform">
	        <h2>osx</h2>
	        <h3>${helpers.msg("download_openframeworks", locals())}</h3>
	        <p><a href="http://www.openframeworks.cc/versions/v${currentVersion}/of_v${currentVersion}_osx_release.zip">osx</a></p><br/>
	        <h3>${helpers.msg("setup_guides", locals())}</h3>
    ...
    <div id="download-bg-mobile">
        <div id="download-latest-platform-title">
	        <h2>mobile</h2>
	        <p><em>${helpers.msg("mobile", locals())}</em></p>
        </div>
    ...
    <div id="download-bg-armlinux">
        <div id="download-latest-platform-title">
	        <h2>linux arm</h2>
	        <p><em>${helpers.msg("linuxarm", locals())}</em></p>
        </div>
    ...
    <br class="clearboth"/>
    ${helpers.msg("instructions", locals())}
    <br />
    <br/>
    ...
    ${helpers.msg("other_releases", locals())}
