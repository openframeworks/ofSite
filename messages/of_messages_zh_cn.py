...
MESSAGES = {
    ...
    '论坛里可以遇见和你一样使用openframeworks的人。在这儿还可以分享你的作品或者寻求帮助解决问题。',
    ...
    'breaking': '是最新发布的版本。新版本包括很多新功能，新接口还有几种终止的变化，版本 ${currentVersion} 与 之前的版本不会有 100% 的兼容性',
    ...
    'mobile': '手机端openFrameworks与桌面版功能一样，在此基础上添加了加速计、指南针、GPS等手机特性功能',
    ...
    'openFrameworks Tutorial Series': 'openFrameworks Tutorial Series',
