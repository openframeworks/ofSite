...
MESSAGES = {
    ...
    '論壇裡可以遇見和你一樣使用openframeworks的人。在這裡還可以分享您的作品或著尋求幫助。',
    ...
    'breaking': '是最新發佈的版本。新版本包括很多新功能，新介面還有幾種終止的變化，版本 ${currentVersion} 與 之前的版本不會有 100% 的相容性',
    ...
    'download_openframeworks': '下載 <br/> openFrameworks',

    'setup_guides': '安裝指南',

    'mobile': '手機版openFrameworks與桌面版功能一樣，在此基礎上添加了加速計、指南針、GPS等手機特性功能',
