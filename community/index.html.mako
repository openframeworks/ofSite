...
<p>To learn more about getting involved in OF, check out the <a href="http://www.openframeworks.cc/list-info/">community mailing list</a>. The community list is ideal for learning about ways to participate, hearing about upcoming events like workshops and conferences, and sharing projects.</p>
<p>To get more in-depth information about OF, join the <a href="http://dev.openframeworks.cc/listinfo.cgi/of-dev-openframeworks.cc">of-dev list</a>!  The dev list is a great place for discussion about the direction OF is heading.  The list is open to everyone, and we like to foster a diverse crowd to help OF become as useful and interesting as possible!</p>
...
<li>Addons leader(s): <a href="jamesgeorge.org/">James George</a> (obviousjim) and <a href="http://gregborenstein.com/">Greg Borenstein</a> (atduskgreg)</li>
