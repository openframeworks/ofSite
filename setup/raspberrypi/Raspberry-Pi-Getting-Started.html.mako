...
0. `cd` 
0. `curl -O http://www.openframeworks.cc/versions/v0.8.2/of_v0.8.2_linuxarmv6l_release.tar.gz` 
0.  `mkdir openFrameworks`
0.  `tar vxfz of_v0.8.2_linuxarmv6l_release.tar.gz -C openFrameworks --strip-components 1`
