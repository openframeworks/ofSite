...
wget http://ci.openframeworks.cc/versions/v${version}/of_v${version}_linux_release.tar.gz 2>> ~/logs/import_release.log

if [ -f of_v${version}_linux64_release.tar.gz ]; then rm of_v${version}_linux64_release.tar.gz; fi
wget http://ci.openframeworks.cc/versions/v${version}/of_v${version}_linux64_release.tar.gz 2>> ~/logs/import_release.log
