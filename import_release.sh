...
wget http://198.61.170.130/versions/v${version}/of_v${version}_msys2_release.zip
if [ -f of_v${version}_vs_release.zip ]; then rm of_v${version}_vs_release.zip; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_vs_release.zip
if [ -f of_v${version}_osx_release.zip ]; then rm of_v${version}_osx_release.zip; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_osx_release.zip
if [ -f of_v${version}_linux_release.tar.gz ]; then rm of_v${version}_linux_release.tar.gz; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_linux_release.tar.gz
if [ -f of_v${version}_linux64_release.tar.gz ]; then rm of_v${version}_linux64_release.tar.gz; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_linux64_release.tar.gz
if [ -f of_v${version}_ios_release.zip ]; then rm of_v${version}_ios_release.zip; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_ios_release.zip
if [ -f of_v${version}_android_release.tar.gz ]; then rm of_v${version}_android_release.tar.gz; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_android_release.tar.gz
if [ -f of_v${version}_linuxarmv6l_release.tar.gz ]; then rm of_v${version}_linuxarmv6l_release.tar.gz; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_linuxarmv6l_release.tar.gz
if [ -f of_v${version}_linuxarmv7l_release.tar.gz ]; then rm of_v${version}_linuxarmv7l_release.tar.gz; fi
wget http://198.61.170.130/versions/v${version}/of_v${version}_linuxarmv7l_release.tar.gz
