...
_syntax: setup(string filename, Type type=ofCairoRenderer::PDF, bool multiPage=true, bool b3D=false)_

_name: setup_

_returns: void_

_parameters: string,  = ofCairoRenderer::PDF, bool = True, bool = False_
...
_name: getCairoMatrix_

_returns: cairo_matrix_t *_
...
_syntax: transform(ofVec3f vec)_
