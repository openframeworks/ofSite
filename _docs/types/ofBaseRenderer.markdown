...
_syntax: draw(ofPolyline &poly)=0_
...
_syntax: draw(vector< ofPoint > &vertexData, ofPrimitiveMode drawMode)=0_
...
_syntax: draw(ofImage &image, float x, float y, float z, float w, float h)=0_
...
_syntax: setRectMode(ofRectMode mode)=0_
...
##ofRectMode getRectMode()=0

_syntax: getRectMode()=0_
...
_syntax: setFillMode(ofFillFlag fill)=0_
...
##ofFillFlag getFillMode()=0

_syntax: getFillMode()=0_
...
_syntax: setLineWidth(float lineWidth)=0_
...
_syntax: setBlendMode(ofBlendMode blendMode)=0_
...
_syntax: setLineSmoothing(bool smooth)=0_
...
##ofColor getBgColor()=0

_syntax: getBgColor()=0_
...
_syntax: drawLine(float x1, float y1, float z1, float x2, float y2, float z2)=0_
...
_syntax: drawRectangle(float x, float y, float z, float w, float h)=0_
...
_syntax: drawTriangle(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3)=0_
...
_syntax: drawCircle(float x, float y, float z, float radius)=0_
...
_syntax: drawEllipse(float x, float y, float z, float width, float height)=0_
...
_syntax: drawString(string text, float x, float y, float z, ofDrawBitmapMode mode)=0_
...
_syntax: rendersPathPrimitives()=0_
