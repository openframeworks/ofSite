...
As of openframeworks 0072 we have a new tool to create openframeworks projects including addons. This makes project creation faster and less error-prone. Traditionally to create a new openframeworks project you had to duplicate an existing example app and add the addons by hand.

## 1. Where is it?

The project generator resides in a folder in the top level of an openframeworks download.

![Image: where is the projectGenerator](002_images/pg-00.png)

![Image: where is the projectGenerator](002_images/pg-01.png)

![Image: where is the projectGenerator](002_images/pg-02.png)
