...
BLOG_AUTHOR = "openFrameworks"  # (translatable)
...
BLOG_EMAIL = "of@openframeworks.cc"
BLOG_DESCRIPTION = "openFrameworks"  # (translatable)
...
MARKDOWN_EXTENSIONS = ['fenced_code', 'extra']
