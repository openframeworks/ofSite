...
### ConstLines(*_begin, *_end, stride, componentsPerPixel, lines, pixelFormat)

<!--
_syntax: ConstLines(*_begin, *_end, stride, componentsPerPixel, lines, pixelFormat)_
_name: ConstLines_
_returns: _
