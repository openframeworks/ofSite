...
### Line(*_begin, stride, componentsPerPixel, lineNum, pixelFormat)

<!--
_syntax: Line(*_begin, stride, componentsPerPixel, lineNum, pixelFormat)_
_name: Line_
_returns: _
...
###ofPixels_::Pixel getPixel(pixel)
...
###ofPixels_::Pixels getPixels(first, numPixels)
...
_returns: bool_
_returns_description: _
_parameters: const ofPixels_::Line &rhs_
_access: public_
_version_started: 0.9.0_
_version_deprecated: _
_summary: _
...
###const ofPixels_::Line & operator*()

<!--
_syntax: operator*()_
_name: operator*_
_returns: const ofPixels_::Line &_
_returns_description: _
_parameters: _
_access: public_
_version_started: 0.9.0_
...
###ofPixels_::Line & operator++()

<!--
_syntax: operator++()_
_name: operator++_
_returns: ofPixels_::Line &_
_returns_description: _
_parameters: _
_access: public_
_version_started: 0.9.0_
