The application module in openFrameworks contains all the classes required to start an application, mostly to create a window and run the infinite update/draw loop.
