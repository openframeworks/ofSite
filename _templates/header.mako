...
<div id="head">
		...
		<ul>
	        ...
	        <li><a href="${bf.config.site.url}/about" title="about" class="${'active' if active=='about' else ''}">about</a></li>
	        <!--a href="${bf.config.site.url}/setup" title="setup" >setup</a> &nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;-->
	        <li><a href="${bf.config.site.url}/download" title="download" class="${'active' if active=='download' else ''}" >download</a></li>
	        <li><a href="${bf.config.site.url}/docs" class="${'active' if active=='docs' else ''}">documentation</a></li>
	        <li><a href="${bf.config.site.url}/gallery" title="gallery" class="${'active' if active=='gallery' else ''}">gallery</a></li>
	        <li><a href="${bf.config.site.url}/community" title="community"  class="${'active' if active=='community' else ''}">community</a></li> 
		</ul>
