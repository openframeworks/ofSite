...
_parameters: const PixelType *_begin, size_t stride, size_t componentsPerPixel, size_t lineNum, ofPixelFormat pixelFormat_
_access: public_
...
###ofPixels_::ConstLine operator+(size_t)
