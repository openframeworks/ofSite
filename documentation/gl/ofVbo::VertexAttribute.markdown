...
<!--
_syntax: VertexAttribute()_
_name: VertexAttribute_
_returns: _
...
###void setBuffer(&buffer, numCoords, stride, offset)

<!--
_syntax: setBuffer(&buffer, numCoords, stride, offset)_
_name: setBuffer_
_returns: void_
_returns_description: _
_parameters: ofBufferObject &buffer, int numCoords, int stride, int offset_
_access: public_
_version_started: 0.10.0_
_version_deprecated: _
_summary: _
