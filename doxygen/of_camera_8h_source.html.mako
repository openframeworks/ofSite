...
<div class="line"><a name="l00042"></a><span class="lineno">   42</span>&#160;    <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#a72cedd2a056d8bf460c2add5cc607179">setupPerspective</a>(<span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#ae6a88528d41af6addd75236037fac3ea">vFlip</a> = <span class="keyword">true</span>, <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#a34bc96c4a0fce3ec78b33db6be83b4fb">fov</a> = 60, <span class="keywordtype">float</span> nearDist = 0, <span class="keywordtype">float</span> farDist = 0, <span class="keyword">const</span> <a class="code" href="classof_vec2f.html">ofVec2f</a> &amp; <a class="code" href="classof_camera.html#a54570e367b902a61cbcbadf4a8ebbd16">lensOffset</a> = <a class="code" href="classof_vec2f.html">ofVec2f</a>(0.0f, 0.0f));</div>
...
<div class="line"><a name="l00045"></a><span class="lineno">   45</span>&#160;    <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#afa77a0f8af4aa2be652a4c8dcd9628c4">setVFlip</a>(<span class="keywordtype">bool</span> vflip);</div>
<div class="line"><a name="l00046"></a><span class="lineno">   46</span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#a6409c2eebe415a9f1a145286fe6e6f5f">isVFlipped</a>();</div>
<div class="line"><a name="l00047"></a><span class="lineno">   47</span>&#160;</div>
<div class="line"><a name="l00048"></a><span class="lineno">   48</span>&#160;    <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#a3188281a0708f7ed030b0742ff2d3f6d">enableOrtho</a>();</div>
<div class="line"><a name="l00049"></a><span class="lineno">   49</span>&#160;    <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#a8b9f8d32444f72544b3a05e6646fcdfc">disableOrtho</a>();</div>
<div class="line"><a name="l00050"></a><span class="lineno">   50</span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#a64ecd6f32c55d31f8570e22a1597c29a">getOrtho</a>() <span class="keyword">const</span>;</div>
<div class="line"><a name="l00051"></a><span class="lineno">   51</span>&#160;    </div>
<div class="line"><a name="l00052"></a><span class="lineno">   52</span>&#160;    <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#a229cb35e80d84ce864e07d569116890e">getImagePlaneDistance</a>(<a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00053"></a><span class="lineno">   53</span>&#160;    </div>
<div class="line"><a name="l00054"></a><span class="lineno">   54</span>&#160;    <span class="comment">// set the matrices</span></div>
...
<div class="line"><a name="l00056"></a><span class="lineno">   56</span>&#160;    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#a2ab2daf9b7432374e6c4bf70a5d94861">end</a>();</div>
<div class="line"><a name="l00057"></a><span class="lineno">   57</span>&#160;    </div>
<div class="line"><a name="l00058"></a><span class="lineno">   58</span>&#160;    <span class="comment">// for hardcore peeps, access to the projection matrix</span></div>
<div class="line"><a name="l00059"></a><span class="lineno">   59</span>&#160;    <a class="code" href="classof_matrix4x4.html">ofMatrix4x4</a> <a class="code" href="classof_camera.html#a69c858a6ecd8f140ac114cec108b3499">getProjectionMatrix</a>(<a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00060"></a><span class="lineno">   60</span>&#160;    <a class="code" href="classof_matrix4x4.html">ofMatrix4x4</a> <a class="code" href="classof_camera.html#aef9fc0a70e89d6807db26d17304c7aa2">getModelViewMatrix</a>() <span class="keyword">const</span>;</div>
<div class="line"><a name="l00061"></a><span class="lineno">   61</span>&#160;    <a class="code" href="classof_matrix4x4.html">ofMatrix4x4</a> <a class="code" href="classof_camera.html#a03586331b2309433c3a8842f6bc333b1">getModelViewProjectionMatrix</a>(<a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00062"></a><span class="lineno">   62</span>&#160;    </div>
<div class="line"><a name="l00063"></a><span class="lineno">   63</span>&#160;    <span class="comment">// convert between spaces</span></div>
<div class="line"><a name="l00064"></a><span class="lineno">   64</span>&#160;    <a class="code" href="classof_vec3f.html">ofVec3f</a> <a class="code" href="classof_camera.html#a7b5e9d4853d39a23fa836dcec18d7ae7">worldToScreen</a>(<a class="code" href="classof_vec3f.html">ofVec3f</a> WorldXYZ, <a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00065"></a><span class="lineno">   65</span>&#160;    <a class="code" href="classof_vec3f.html">ofVec3f</a> <a class="code" href="classof_camera.html#a2d561fd8fb958c9512d576ed54129a73">screenToWorld</a>(<a class="code" href="classof_vec3f.html">ofVec3f</a> ScreenXYZ, <a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00066"></a><span class="lineno">   66</span>&#160;    <a class="code" href="classof_vec3f.html">ofVec3f</a> <a class="code" href="classof_camera.html#a32da4f33ddc9b4ee49aed5f5840813e1">worldToCamera</a>(<a class="code" href="classof_vec3f.html">ofVec3f</a> WorldXYZ, <a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00067"></a><span class="lineno">   67</span>&#160;    <a class="code" href="classof_vec3f.html">ofVec3f</a> <a class="code" href="classof_camera.html#a0b71942ab459cce76425154c52032363">cameraToWorld</a>(<a class="code" href="classof_vec3f.html">ofVec3f</a> CameraXYZ, <a class="code" href="classof_rectangle.html">ofRectangle</a> viewport = <a class="code" href="of_graphics_8cpp.html#a9b45fc63c10fdf222fcbf20543183220">ofGetCurrentViewport</a>()) <span class="keyword">const</span>;</div>
<div class="line"><a name="l00068"></a><span class="lineno">   68</span>&#160;    </div>
<div class="line"><a name="l00069"></a><span class="lineno">   69</span>&#160;    </div>
<div class="line"><a name="l00070"></a><span class="lineno">   70</span>&#160;<span class="keyword">protected</span>:</div>
<div class="line"><a name="l00071"></a><span class="lineno">   71</span>&#160;    <span class="keywordtype">void</span> <a class="code" href="classof_camera.html#a14be7a543e64f332e9f3106fce2b369f">calcClipPlanes</a>(<a class="code" href="classof_rectangle.html">ofRectangle</a> viewport);</div>
<div class="line"><a name="l00072"></a><span class="lineno">   72</span>&#160;    </div>
<div class="line"><a name="l00073"></a><span class="lineno"><a class="code" href="classof_camera.html#a741a221b952bd29fc717eda23565ee22">   73</a></span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#a741a221b952bd29fc717eda23565ee22">isOrtho</a>;</div>
<div class="line"><a name="l00074"></a><span class="lineno"><a class="code" href="classof_camera.html#a34bc96c4a0fce3ec78b33db6be83b4fb">   74</a></span>&#160;    <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#a34bc96c4a0fce3ec78b33db6be83b4fb">fov</a>;</div>
<div class="line"><a name="l00075"></a><span class="lineno"><a class="code" href="classof_camera.html#ad11580161e4664656d26013f6638769c">   75</a></span>&#160;    <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#ad11580161e4664656d26013f6638769c">nearClip</a>;</div>
<div class="line"><a name="l00076"></a><span class="lineno"><a class="code" href="classof_camera.html#a1af538e481519a184d4320cedd456fb9">   76</a></span>&#160;    <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#a1af538e481519a184d4320cedd456fb9">farClip</a>;</div>
<div class="line"><a name="l00077"></a><span class="lineno"><a class="code" href="classof_camera.html#a54570e367b902a61cbcbadf4a8ebbd16">   77</a></span>&#160;    <a class="code" href="classof_vec2f.html">ofVec2f</a> <a class="code" href="classof_camera.html#a54570e367b902a61cbcbadf4a8ebbd16">lensOffset</a>;</div>
<div class="line"><a name="l00078"></a><span class="lineno"><a class="code" href="classof_camera.html#a5f80899f0f5b8c699f4e476879bd5441">   78</a></span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#a5f80899f0f5b8c699f4e476879bd5441">forceAspectRatio</a>;</div>
<div class="line"><a name="l00079"></a><span class="lineno"><a class="code" href="classof_camera.html#a6dfc2ca4d2b9920888f5d2df0cd21413">   79</a></span>&#160;    <span class="keywordtype">float</span> <a class="code" href="classof_camera.html#a6dfc2ca4d2b9920888f5d2df0cd21413">aspectRatio</a>; <span class="comment">// only used when forceAspect=true, = w / h</span></div>
<div class="line"><a name="l00080"></a><span class="lineno"><a class="code" href="classof_camera.html#a960e80a1ae5ac42560a4b01c63b62e49">   80</a></span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#a960e80a1ae5ac42560a4b01c63b62e49">isActive</a>;</div>
<div class="line"><a name="l00081"></a><span class="lineno"><a class="code" href="classof_camera.html#ae6a88528d41af6addd75236037fac3ea">   81</a></span>&#160;    <span class="keywordtype">bool</span> <a class="code" href="classof_camera.html#ae6a88528d41af6addd75236037fac3ea">vFlip</a>;</div>
