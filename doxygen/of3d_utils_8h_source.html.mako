...
<div class="line"><a name="l00004"></a><span class="lineno">    4</span>&#160;<span class="keywordtype">void</span> <a class="code" href="of3d_utils_8cpp.html#a30cb936226988baf93141d8a14eabd31" title="Draws x,y,z axes representing the current reference frame  Axes are drawn in red (+x), green (+y) and blue (+z) ">ofDrawAxis</a>(<span class="keywordtype">float</span> size);</div>
