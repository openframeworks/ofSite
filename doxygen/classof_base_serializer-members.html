...
<div class="title">ofBaseSerializer Member List</div>  </div>
</div><!--header-->
<div class="contents">

<p>This is the complete list of members for <a class="el" href="classof_base_serializer.html">ofBaseSerializer</a>, including all inherited members.</p>
<table class="directory">
  ...
  <tr class="even"><td class="entry"><a class="el" href="classof_base_serializer.html#ac0f625f8066cd4d6fac7b617ea27c88d">~ofBaseSerializer</a>()</td><td class="entry"><a class="el" href="classof_base_serializer.html">ofBaseSerializer</a></td><td class="entry"><span class="mlabel">inline</span><span class="mlabel">virtual</span></td></tr>
</table></div><!-- contents -->
