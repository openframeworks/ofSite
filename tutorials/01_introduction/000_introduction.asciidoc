...
openFrameworks is an link:/about/license/[open source] http://en.wikipedia.org/wiki/C%2B%2B"[C++] toolkit designed to assist the creative process by providing a simple and intuitive framework for experimentation. The toolkit is designed to work as a general purpose glue, and wraps together several commonly used libraries, including:
...
openFrameworks is actively developed by http://thesystemis.com/[Zach Lieberman], http://muonics.net/[Theodore Watson], and http://arturocastro.net/[Arturo Castro], with help from the link:/community/[OF community]. openFrameworks is indebted to two significant precursors: the http://processing.org/[Processing development environment], created by http://reas.com/[Casey Reas], http://benfry.com/[Ben Fry] and the Processing community; and the ACU Toolkit, a privately distributed C++ library developed by Ben Fry and others in the http://acg.media.mit.edu/[MIT Media Lab's Aesthetics and Computation Group].
__________________________
...
. Go into /Applications/Utilities and double-click on Terminal.app image:Terminal.png["Terminal.app",height=24]
...
Windows
^^^^^^^
- link:/setup/codeblocks/[Code::Blocks setup guide]
- link:/setup/vs/[Visual Studio setup guide]

Mac
^^^
- link:/setup/xcode/[Xcode Setup Guide]

Linux
^^^^^
- link:/setup/linux-codeblocks/[Linux Code::Blocks & makefiles]
- link:/setup/raspberrypi/[Raspberry Pi]
...
~~~~~~~~~~~~~~~~~~~~~~~
- link:/about/[About openFrameworks] More about openFrameworks, including the design methodology.
- link:/documentation/[Official Documentation] Where you can find descriptions of classes and functions that make up openFrameworks
